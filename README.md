...
|:--------------:|:----------------------------------------------------------:|:---------:|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|      urls      | `string`｜`RegExp`｜`(string｜RegExp)[]`｜`Set<string｜RegExp>` |    yes    | The URLs to be verified against the URL parameter.<br/>If not specified, the listener runs on any URL.                                                                                                                                                                                                                                                                                          |
|   targetIds    | `string`｜`string[]`｜`Set<string>`｜<br/>`Object.<string,*>` |    yes    | The target IDs to be verified against the event target ID.<br/>If not specified, no `targetIds` are associated with the listener.                                                                                                                                                                                                                                                               |
